               ...
               <table class="table table-striped table-bordered table-list">
                 ...
                 <tbody>
                         ...
                         <td>
                           ...
                           <td><a href="product?id=${p.p_id}"><img src="${pageContext.request.contextPath}/resources/images/${p.p_image}"  class="img-rounded" alt="${p.p_name }" width="75px" height="50px"/></a></td>         
                           <tr>       
                         </c:forEach>
                       </tbody>
               </table>
